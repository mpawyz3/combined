...
import { Crown, TrendingUp, Users, Star, Calendar, Briefcase, Play, Award, Plus, ArrowRight, Loader } from 'lucide-react';
...
export default function Dashboard() {
  ...
  // Use challenges from hook (already filtered to active ones)
